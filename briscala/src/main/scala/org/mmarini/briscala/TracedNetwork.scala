 ...
 *
 */
class TracedNetwork(w1: DenseMatrix[Double], w2: DenseMatrix[Double], w3: DenseMatrix[Double], e1: DenseMatrix[Double], e2: DenseMatrix[Double], e3: DenseMatrix[Double]) extends Network(w1, w2, w3) {
   ...
   *
   */
  def this(w1: DenseMatrix[Double], w2: DenseMatrix[Double], w3: DenseMatrix[Double]) =
    this(w1, w2, w3,
   ...
   */
  def learn(x: DenseVector[Double], y: DenseVector[Double], c: Double, lambda: Double): (TracedNetwork, Double) = {
